---
title: "NEEA Survey Program Manager Exercise"
output: 
  html_notebook:
    toc: true
    toc_float: true
...
<center>![](neea_logo.png)</center>

# Introduction
This notebook was created on 10/01/2025 by Neil Yetz, M.P.H. The purpose of this notebook is to display how I would tackle a problem associated as a Survey Program manager at Northwest Energy Efficiency Alliance (NEEA).

Data used from the 2022 Residential Building Stock Assessment (RBSA). Data user guide available here: https://neea.org/wp-content/uploads/2025/03/2022-RBSA-Data-User-Guide.pdf

Dataset is available for request here: https://neea.org/resource/2022-residential-building-stock-assessment-datasets/
...
## Census Map Download
Retrieve Shape Files from Census
```{r}
...
### Filter file and merge sampled zip codes
```{r}
...
# Manufactured Home analyses
## Map 2: sampled Manufacture home area
```{r}
...
## Rural Urban Communities Continuum
```{r}
